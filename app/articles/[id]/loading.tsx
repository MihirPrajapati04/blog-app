  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
      <div className="text-center flex flex-col items-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">Please wait while we show your Article...</p>
      </div>
    </div>
  );
};

export default ArticleIdLoadingScreen;